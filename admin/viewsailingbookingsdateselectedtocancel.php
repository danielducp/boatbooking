...
<tr style="background: #E6F2FF;">
   ...
   <tr >
    ...
    <td style="padding: 14px;"><?php echo $product['BoatName']; ?></td>
        <td style="padding: 14px;"><?php echo $product['Email']; ?></td>
   
  <td style="padding: 14px;"><?php echo $product['CancelledStatus']; ?></td>
       ...
       <?php
          ...
          <?php endforeach; ?>
               ...
               <form action="CancelBookings.php" method="post" >
            <input type="hidden" name="SailingDate" value="<?=$product['BookingSailingDate']?>">
    <td>
    </td>   

            <td>
            <input name="submit" value="Cancel the day" class="btn btn-info" type="submit">
</td>    
</form>   
          </div>
