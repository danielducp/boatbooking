...
$sql = "UPDATE SeasonDates SET  
           SeasonStartDate = :SeasonStartDate,
           SeasonEndDate = :SeasonEndDate
            WHERE SeasonDatesID = :SeasonDatesID";
            


$sqlQuery = $pdo->prepare($sql); 
$sqlQuery->bindParam(':SeasonStartDate', $_POST['SeasonStartDate']); 

$sqlQuery->bindParam(':SeasonEndDate', $_POST['SeasonEndDate']); 

$sqlQuery->bindParam(':SeasonDatesID', $_POST['SeasonDatesID']); 

$sqlQuery->execute(); 

echo "<h1  align=center>Dates updated</h1>";
