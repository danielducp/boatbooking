...
$sql = "UPDATE Booking SET  
           ArrivalStatusName = :ArrivalStatusName
            WHERE BookingNumber = :BookingNumber";
            


$sqlQuery = $pdo->prepare($sql); 
$sqlQuery->bindParam(':ArrivalStatusName', $_POST['ArrivalStatusName']); 
...
echo "<h1  align=center>Booking updated</h1>";
header('Refresh: 5; ../admin/UpdateBookings.php');
