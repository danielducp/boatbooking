...
<select required name="amountofboats" id="amountofboats"  searchable="Search here" style="font-size: 40px; padding-right: 29px; display: inline-block;">
...
<select required name="amountofboats" id="amountofboats"  searchable="Search here" class="selectionbox">
      <option  value="" disabled selected>Select your option</option>
