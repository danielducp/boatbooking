...
<a class="navbar-brand" href="#">
    <img src="../pictures/Sailability.svg" width="30" height="30" class="d-inline-block align-top" alt="Peterborough Sailaiblity Logo">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="newboatbooking.php">Booking</a>
          ...
          <li class="nav-item">
        <a class="nav-link" href="viewallofmybookings.php">View all of my bookings</a>
      </li>
      <li class="nav-item">
